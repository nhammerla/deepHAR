function processDir(dirPath, labelsLoc, indicesOfSubjectNumInFileName, indicesOfRunNumInFileName, normalize, sampleBySample, subsetCols, slidWin, stepSize, windowSize,trainPart, valPart, testPart, ignoreClasses,changeLabels,doKNN,convert2torch)
